function [trainFV, trainY, valFV, valY]=...
            get_activations_dataset_network_layer4FroBiSVM(dataset, network, endLayer, classificationType, initMethod, use448, net, batchSize)
...
%     net = addBilinear(net);
    ...
    % !!!! comment this line soon !!!!
%     net.layers = net.layers(1:end-1);
    % !!!! comment the above line soon !!!!
    ...
    if exist(feature_out_file, 'file') == 2
        ...
        %%%%%%% comment later
%         train = [train train ]; % augmentation ---
