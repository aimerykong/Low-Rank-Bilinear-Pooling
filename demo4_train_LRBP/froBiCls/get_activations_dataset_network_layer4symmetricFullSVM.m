function [trainFV, trainY, valFV, valY]=...
            get_activations_dataset_network_layer4symmetricFullSVM(dataset, network, endLayer, classificationType, initMethod, use448, net, batchSize)
