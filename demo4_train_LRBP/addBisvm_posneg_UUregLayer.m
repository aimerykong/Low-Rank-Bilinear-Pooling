function net = addBisvm_posneg_UUregLayer( net, lossType, initFCparam, rDimBiCls, num_classes, learnW, lambda)
%
...
net.layers{end+1} = struct('type', 'custom',...
    'forward', @bisvm_posneg_UUreg_forward, ...
    'backward', @bisvm_posneg_UUreg_backward, ...
    'name', 'biCls', ...
