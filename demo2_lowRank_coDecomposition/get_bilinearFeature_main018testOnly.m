function [valFV, valY]=...
            get_bilinearFeature_main018testOnly(dataset, network, endLayer, classificationType, initMethod, use448, net, batchSize)
...
%     net = addBilinear(net);
    ...
    if exist(feature_out_file, 'file') == 2
        ...
        rng(777);
        valNum = 1000;
        a = find(imdb.images.set==3);
        b = randperm(length(a));
        valIdx = a(b(1:valNum));
        imdb.images.set(valIdx) = 1;
